...
def main():
    ...
    parser.add_argument("type",type=str,help="either pdf or text. Default is text", default="text")
    ...
    db = Chroma(
         collection_name="text_collections" if type.lower() == "text" else "pdf_collection",
         persist_directory=constants.CHROMA_DB_PATH if type.lower() == "text" else constants.CHROMA_PDF_DB_PATH, 
